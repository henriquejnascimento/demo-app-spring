...
public class ErrorConstant {
    ...
    public static final String FILE_NOT_FOUND_ERROR_MESSAGE_TEMPLATE = "File not found with id %d";
    ...
    public static String buildFileNotFoundErrorMessage(final Long id) {
        return String.format(FILE_NOT_FOUND_ERROR_MESSAGE_TEMPLATE, id);
    }
